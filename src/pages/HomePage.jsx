      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        <div className="space-y-8">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-gray-900 leading-tight">
            <span className="block">Pengelompokan dan Analisis</span>
          ...
          <p className="max-w-4xl mx-auto text-xl text-gray-600 leading-relaxed">
            ...
            <strong>K-Means</strong>, <strong>Fuzzy C-Means</strong>, dan{" "}
            <strong>Spectral Clustering</strong> untuk memetakan pola
            kewilayahan harga pangan strategis, memberikan wawasan mendalam bagi
            perumusan kebijakan yang lebih efektif dan berbasis data.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Pendekatan sistematis dalam analisis data harga pangan menggunakan
            teknologi terkini
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              description:
                "Hasil analisis disajikan dalam bentuk peta interaktif dan grafik dinamis untuk eksplorasi mendalam dan pemahaman yang intuitif.",
      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        <div className="bg-white rounded-3xl shadow-2xl p-12 transform hover:scale-105 transition-all duration-300">
          ...
          <p className="text-xl text-gray-600 mb-8 leading-relaxed">
            Masuki dashboard interaktif dan temukan wawasan mendalam tentang
            pola harga pangan di Indonesia Bagian Barat melalui analisis
            clustering yang canggih.
          </p>
          <button
            onClick={() => setCurrentPage("Dashboard")}
