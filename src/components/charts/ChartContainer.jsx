...
const ChartContainer = ({ data }) => {
    ...
    return (
        <div className="space-y-6">
                ...
                <div>
                    ...
                    <p className="text-gray-600">
                        {chartType === "trend"
                            ...
                            : chartType === "radar"
                            ? "Visualisasi radar menampilkan profil unik setiap klaster berdasarkan harga"
                            : chartType === "boxplot"
            ...
            {hasData && (chartType === "trend" || chartType === "boxplot") && (
                <div className="flex items-center justify-center space-x-3">
                    ...
                    <select
                        ...
                        className="px-4 py-2 bg-white border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:border-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200 min-w-[200px]"
                    >
                                ...
                                {chartType === "radar" ? (
                                    <>
                                        ...
                                        <p>
                                            ...
                                            karakteristik harga klaster tersebut
                                        </p>
                                    </>
                                ) : chartType === "boxplot" ? (
                                    <>
                                        <p>
                                            ...
                                            Menampilkan distribusi harga dari
                                            semua data point per komoditas
                                        </p>
                                        <p>
                                            • <strong>Setiap Box:</strong>{" "}
                                            Mewakili satu klaster dengan warna
                                            yang konsisten
                                        </p>
                                        <p>
                                            • <strong>Box menunjukkan:</strong>{" "}
                                            Q1, median (garis tebal), dan Q3;
                                            whiskers menunjukkan min-max
                                        </p>
                                        <p>
                                            • <strong>Outliers:</strong>{" "}
                                            Ditampilkan sebagai titik di luar
                                            whiskers
                                        </p>
                                    </>
                                ) : chartType === "heatmap" ? (
                                    <>
                                        <p>
                                            ...
                                            Korelasi positif kuat (harga
                                            cenderung bergerak searah)
                                        </p>
                                        <p>
                                            • <strong>Warna Biru:</strong>{" "}
                                            Korelasi negatif (harga bergerak
                                            berlawanan arah)
                                        </p>
                                        <p>
                                            • <strong>Warna Putih:</strong>{" "}
                                            Tidak ada korelasi atau korelasi
                                            lemah
                                        </p>
                                        <p>
                                            • <strong>Nilai 1.00:</strong>{" "}
                                            Korelasi sempurna (diagonal utama -
                                            komoditas dengan dirinya sendiri)
                                        </p>
                                    </>
                                ) : chartType === "scatter" ? (
                                    <>
                                        <p>
                                            • <strong>Titik-titik:</strong>{" "}
                                            Mewakili kota dalam ruang 2D yang
                                            direduksi dari data komoditas
                                        </p>
                                        <p>
                                            • <strong>Warna:</strong>{" "}
                                        ...
                                        <p>
                                            ...
                                            untuk zoom, drag untuk pan, reset
                                    ...
                                    <>
                                        ...
                                        <p>
                                            • Setiap warna garis
                                            merepresentasikan klaster yang
