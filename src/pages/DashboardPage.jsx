...
const DashboardPage = () => {
        ...
        if (source === "upload") {
          ...
          if (!validationResponse.ok) {
            ...
            if (errorData.message) {
              ...
              errorMessage = errorData.details.format_errors.join(", ");
            }
          ...
          try {
            ...
            throw new Error("Invalid JSON response from validation endpoint");
          }
          ...
          if (!response.ok) {
            try {
              ...
              console.error("App Data Error Response:", errorData);
              ...
              console.error("App Data Error Response (text):", errorText);
              throw new Error(
  ...
  // Validation handlers
  const handleValidatedAnalysis = useCallback(async (validationId, config) => {
    try {
      setIsLoading(true);
      setError(null);
      ...
      if (!response.ok) {
        try {
          const errorData = await response.json();
          console.error("Validated Analysis Error Response:", errorData);
          ...
          console.error("JSON parse error:", parseError);
          const errorText = await response.text();
          console.error("Validated Analysis Error Response (text):", errorText);
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-green-700 mt-1">
                  Data clustering telah diproses dan ditampilkan di dashboard.
                </p>
              </div>
              <button
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-6">
              Eksplorasi interaktif hasil clustering harga pangan dengan
              visualisasi peta dan grafik yang komprehensif
            </p>
          </div>
        </div>
      </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Visualisasi geografis hasil clustering
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-green-50 to-emerald-50">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Pengaturan analisis</p>
                  </div>
                </div>
              </div>
              <div className="p-6">
                <AnalysisProvider defaultMode={mode}>
                  <AnalysisWrapper analysisId={analysisId}>
                    ...
                    <ValidationFlowHandler
                      ...
                      onValidatedAnalysis={handleValidatedAnalysis}
                      onReupload={handleReupload}
                      onClear={() => setPendingValidationResult(null)}
                    />
                    <ValidationHandler
                      onValidatedAnalysis={handleValidatedAnalysis}
                      onReupload={handleReupload}
        ...
        {isComparisonMode ? (
          <div className="mt-8">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-6">
                <ComparisonContainer data={memoizedAnalysisData} />
              </div>
            </div>
          </div>
        ) : (
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Perbandingan tren harga antar klaster
                      </p>
                    </div>
                  </div>
          ...
          {[
            ...
            },
            {
              ...
              value: memoizedAnalysisData?.trends
                ? Object.keys(memoizedAnalysisData.trends).length
                : 0,
              icon: "🌾",
