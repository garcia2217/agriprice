        ...
        <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="space-y-4">
                    ...
                    <p className="text-gray-300 text-sm leading-relaxed">
                        Analisis clustering harga pangan menggunakan machine
                        learning untuk mendukung kebijakan pangan yang lebih
                ...
                {/* Contact Info */}
                <div className="space-y-4">
                    <h3 className="font-semibold text-white">Peneliti</h3>
            ...
            <div className="mt-8 pt-6 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <div className="text-gray-400 text-sm text-center md:text-left">
                    <p>
                        &copy; 2025 AgriPrice Analytics. Dibuat untuk penelitian
                        skripsi.
                    </p>
                </div>
