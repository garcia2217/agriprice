      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Dedikasi untuk kemajuan ilmu pengetahuan melalui penelitian berbasis
            data dan teknologi
          </p>
        </div>
      </div>
            ...
            <div className="relative bg-gradient-to-br from-blue-600 to-indigo-700 p-12 flex items-center justify-center">
              ...
              <div className="relative z-10 text-center">
                ...
                <div className="flex justify-center space-x-4">
                  ...
                  <a
                    href="mailto:emmanoelgarsia@gmail.com"
                    className="p-3 bg-white/20 backdrop-blur-md rounded-xl text-white hover:bg-white/30 hover:scale-110 transition-all duration-300"
                  >
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <div className="flex items-center space-x-2 text-blue-600 font-semibold mb-6">
                    <span>🏛️</span>
                    <span>Teknik Informatika, Universitas Tarumanagara</span>
                  </div>
                </div>

                <div className="prose prose-lg text-gray-600">
                  <p className="leading-relaxed">
                    Saya adalah seorang mahasiswa tingkat akhir dengan passion
                    mendalam pada bidang
                    <strong className="text-blue-600"> Data Science</strong>,
                  ...
                  <p className="leading-relaxed">
                    Penelitian ini merupakan puncak dari perjalanan akademis
                    saya, menggabungkan kemampuan analisis data dengan
                    pengembangan aplikasi web yang fungsional dan informatif.
                    Melalui penerapan algoritma clustering, saya berusaha
                    memberikan kontribusi nyata bagi pemahaman pola harga pangan
                    di Indonesia.
                  </p>
                </div>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Area penelitian dan minat akademis yang sedang dikembangkan
          </p>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-3xl p-12 text-white">
          ...
          <p className="text-xl mb-8 opacity-90 leading-relaxed">
            Tertarik untuk berdiskusi tentang penelitian ini atau mengeksplorasi
            peluang kolaborasi? Saya selalu terbuka untuk berbagi pengetahuan
