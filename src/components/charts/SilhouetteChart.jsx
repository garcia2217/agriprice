                ...
                plugins: {
                    ...
                    tooltip: {
                        ...
                        callbacks: {
                            title: (context) => {
                                const city =
                                    citySilhouettes[context[0].dataIndex];
                                return city.city;
                            },
                            label: (context) => {
                                const city = citySilhouettes[context.dataIndex];
                                return [
                                    `Silhouette Score: ${city.silhouette.toFixed(
                                        3
                                    )}`,
                ...
                <div className="p-8">
                    <div className="mb-4">
                        ...
                        <p className="text-sm text-gray-600">
                            Bar colors represent cluster membership. Higher
                            ...
                            >
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <div className="text-sm text-gray-600">
                                        Avg Silhouette:{" "}
                                        {cluster.avgSilhouette.toFixed(3)}
                                    </div>
                                </div>
